# ADR-019: Residual Risks Checklist Bridge (Implement → Verify フェーズ間継承)
...
| `refine-loop/.apm/skills/call-refine-loop/SKILL.md` | `requirements_checklist` と `task_context` パラメータ説明に ADR-019 ルールを明記 |
